...
<head>
    ...
    <style>
        .my-bookings-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../assets/img/cities/navsari.webp');
                    ...
                    <?php while ($booking = mysqli_fetch_assoc($result)): ?>
                        <div class="booking-card">
                            ...
                            <div class="booking-content">
                                ...
                                <div class="booking-details">
                                    ...
                                    <p>
                                        ...
                                        <?php echo htmlspecialchars($booking['number_of_travelers']); ?>
                                    </p>
                            ...
                            <div class="booking-actions">
                                <a href="package-detail.php?id=<?php echo $booking['package_id']; ?>" class="btn">
                                    View Package
                                </a>
                            </div>
                        </div>
